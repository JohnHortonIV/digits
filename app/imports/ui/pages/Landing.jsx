        ...
        <Grid container stackable centered columns={3}>
          ...
          <Grid.Column textAlign='center'>
            ...
            <Header as='h1' inverted>Multiple Users</Header>
              <Header as='h3' inverted>This address book enables any number of users to register and
                  save their business contacts. You can only see the contacts you have created</Header>
          </Grid.Column>
            <Grid.Column textAlign='center'>
                <Icon size='huge' name='file alternate' inverted/>
                <Header as='h1' inverted>Contact Deatails</Header>
